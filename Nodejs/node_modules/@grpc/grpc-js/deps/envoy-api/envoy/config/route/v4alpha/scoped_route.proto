...
message ScopedRouteConfiguration {
  ...
  message Key {
    ...
    message com.example.vietis_fuddy.Fragment {
      option (udpa.annotations.versioning).previous_message_type =
          "envoy.config.route.v3.ScopedRouteConfiguration.Key.com.example.vietis_fuddy.Fragment";
    ...
    // :ref:`scope_key_builder<envoy_api_field_extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.scope_key_builder>`.
    repeated com.example.vietis_fuddy.Fragment fragments = 1 [(validate.rules).repeated = {min_items: 1}];
  }
